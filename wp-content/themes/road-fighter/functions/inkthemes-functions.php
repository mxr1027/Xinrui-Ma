...
function roadfighter_setup() {
    ...
    //Load languages file
    load_theme_textdomain('rdf', get_template_directory() . '/languages');
    $locale = get_locale();
...
function roadfighter_register_custom_menu() {
    register_nav_menu('custom_menu', __('Main Menu', 'rdf'));
}
...
function roadfighter_nav_menu_items($items) {
    if (is_home()) {
        $homelink = '<li class="current_page_item">' . '<a href="' . esc_url(home_url('/')) . '">' . __('Home', 'rdf') . '</a></li>';
    } else {
        $homelink = '<li>' . '<a href="' . esc_url(home_url('/')) . '">' . __('Home', 'rdf') . '</a></li>';
    }
...
function roadfighter_breadcrumbs() {
    ...
    if (get_query_var('paged')) {
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ' (';
        echo __('Page', 'rdf') . ' ' . get_query_var('paged');
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ')';
    }
    echo '</div>';
...
// Retrieves tag list of current post, separated by commas.
    ...
    if ($tag_list) {
        $posted_in = __('This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'rdf');
    } elseif (is_object_in_taxonomy(get_post_type(), 'category')) {
        $posted_in = __('This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'rdf');
    } else {
        $posted_in = __('Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'rdf');
    }
...
// Area 1, located at the top of the sidebar.
    register_sidebar(array(
        'name' => __('Primary Widget Area', 'rdf'),
        'id' => 'primary-widget-area',
        'description' => __('The primary widget area', 'rdf'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
    register_sidebar(array(
        'name' => __('Secondary Widget Area', 'rdf'),
        'id' => 'secondary-widget-area',
        'description' => __('The secondary widget area', 'rdf'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
    ...
    register_sidebar(array(
        'name' => __('First Footer Widget Area', 'rdf'),
        'id' => 'first-footer-widget-area',
        'description' => __('The first footer widget area', 'rdf'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Second Footer Widget Area', 'rdf'),
        'id' => 'second-footer-widget-area',
        'description' => __('The second footer widget area', 'rdf'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Third Footer Widget Area', 'rdf'),
        'id' => 'third-footer-widget-area',
        'description' => __('The third footer widget area', 'rdf'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        'name' => __('Fourth Footer Widget Area', 'rdf'),
        'id' => 'fourth-footer-widget-area',
        'description' => __('The fourth footer widget area', 'rdf'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
