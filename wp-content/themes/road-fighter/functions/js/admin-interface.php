...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/functions/js/colorpicker.js"></script>
    <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/functions/js/tiny_mce/tiny_mce.js"></script>
    <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/functions/js/tiny_mce_init.js"></script>  
