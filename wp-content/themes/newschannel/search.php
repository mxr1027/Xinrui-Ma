        ...
        <div id="main" class="clearfix" role="main">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'newschannel' ), '<span class="black">' . get_search_query() . '</span>' ); ?></h1>
				</header>
			...
			<?php else : ?>
				...
				<article id="post-0" class="post no-results not-found">
					...
					<div class="entry-content post_content">
						<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'newschannel' ); ?></p>
						<?php get_search_form(); ?>
					</div><!-- .entry-content -->
