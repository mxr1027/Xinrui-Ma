		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'text_money':
					...
					break;
				case 'colorpicker':
					echo '<input class="cmb_colorpicker cmb_text_small" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : "#", '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
					break;
				case 'textarea':
