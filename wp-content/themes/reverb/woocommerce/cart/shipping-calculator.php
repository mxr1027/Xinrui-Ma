...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	<h5><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <span>&darr;</span></a></h5>
	<section class="shipping-calculator-form">
		...
		<div class="clear"></div>
		<p><button type="submit" name="calc_shipping" value="1" class="btn"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
