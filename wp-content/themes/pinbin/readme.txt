...
== Version history ==
v1.4.4 -Updated copyright/license information 

v1.4.3 -Updated copyright/license information 

v1.4.2 -Added license information for the default image
		Navigation now wrapped within div.
		Improved page navigation. Now wrapped with "nav".
		Updated screenshot 

v1.4.1 -Added default image
		Updated screenshot

v1.4 - 	Major CSS overhaul to reduce its size.
		Improved responsiveness on mobile devices (search page and post page).
		Improved lists styles
		Updated comments section

v1.3 - 	Minor CSS improvements
